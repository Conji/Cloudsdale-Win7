...
namespace Cloudsdale_Win7.Win7_Lib.Models
{
    public sealed class Ban : Cloudsdale_Lib {
        ...
        /// The enforcing user
        /// </summary>
        public User Enforcer { get { return Cloudsdale_Lib.UserProvider.GetUser(EnforcerId); } }
        /// <summary>
        /// The cloud where the ban was enacted
        /// </summary>
        public Cloud Jurisdiction { get { return Cloudsdale_Lib.CloudProvider.GetCloud(JurisdictionId); } }
