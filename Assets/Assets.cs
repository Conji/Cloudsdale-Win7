...
namespace Cloudsdale_Win7.Assets
{
    class Assets
    {
        ...
        public static Color PrimaryBlue_Dark = Color.FromRgb(63, 133, 179);
        ...
        public static Color Error_Bright = Color.FromRgb(191, 94, 91);
        public static Color Error_Dark = Color.FromRgb(183, 76, 73);
        public static Color Success_Bright = Color.FromRgb(128, 206, 0);
        public static Color Success_Dark = Color.FromRgb(112, 180, 0);
