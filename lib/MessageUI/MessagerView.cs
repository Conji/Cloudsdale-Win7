...
namespace Cloudsdale.lib.MessageUI
{
    public partial class MessageBox : System.Windows.Forms.Control
	{
		...
		public Object DataSource
		{
			...
			{
				m_dataSource = value;
				m_list = GetInnerDataSource(m_dataSource as MessageSource);
				if (m_list != null)
				{
	...
	public class Message
	{
		...
		{
			Name = name;
			UserMessage = currentTime;
			Picture = null;
			ConsoleImage = "";
		}
		public Message(string name, string message, Image picture, string console)
		{
			Name = name;
			UserMessage = message;
			Picture = picture;
		...
		public Message(string name, string message, Image picture)
		{
			Name = name;
			UserMessage = message;
			Picture = picture;
